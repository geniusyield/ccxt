...
var geniusyield$1 = require('./abstract/geniusyield.js');
 ...
 * @augments Exchange
 */
class geniusyield extends geniusyield$1 {
    describe() {
        return this.deepExtend(super.describe(), {
            ...
            'urls': {
                'test': {
                    'MATIC': 'https://api-sandbox-matic.geniusyield.io',
                },
                'logo': 'https://user-images.githubusercontent.com/51840849/94481303-2f222100-01e0-11eb-97dd-bc14c5943a86.jpg',
                'api': {
                    'MATIC': 'https://api-matic.geniusyield.io',
                },
                'www': 'https://geniusyield.io',
                'doc': [
                    'https://api-docs-v3.geniusyield.io/',
                ],
            },
            'api': {
                'public': {
    ...
    async fetchMarkets(params = {}) {
        ...
        //        "geniusyieldStakingValueLockedUsd": "20133816.98",
        //        "geniusyieldTokenAddress": "0x9Cb74C8032b007466865f060ad2c46145d45553D",
        //        "geniusyieldUsdPrice": "0.07",
        //        "geniusyieldMarketCapUsd": "48012346.00",
        //        "makerFeeRate": "0.0000",
        //        "takerFeeRate": "0.0025",
    ...
    async fetchTicker(symbol, params = {}) {
        /**
         * @method
         * @name geniusyield#fetchTicker
         * @description fetches a price ticker, a statistical calculation with the information calculated over the past 24 hours for a specific market
         * @see https://api-docs-v3.geniusyield.io/#get-tickers
    ...
    async fetchOHLCV(symbol, timeframe = '1m', since = undefined, limit = undefined, params = {}) {
        /**
         * @method
         * @name geniusyield#fetchOHLCV
         * @description fetches historical candlestick data containing the open, high, low, and close price, and the volume of a market
         * @see https://api-docs-v3.geniusyield.io/#get-candles
    ...
    async fetchTrades(symbol, since = undefined, limit = undefined, params = {}) {
        /**
         * @method
         * @name geniusyield#fetchTrades
         * @description get the list of most recent trades for a particular symbol
         * @see https://api-docs-v3.geniusyield.io/#get-trades
    ...
    parseTrade(trade, market = undefined) {
        ...
        //      "makerSide":"sell",
        //      "sequence":31795,
        //      "market":"Genius Yield-USDC",
        //      "orderId":"4fe993f0-747b-11ec-bd08-79d4a0b6e47c",
        //      "side":"buy",
        //      "fee":"0.03749989",
        //      "feeAsset":"Genius Yield",
        //      "gas":"0.40507261",
        //      "liquidity":"taker",
        //      "type":"hybrid",
    ...
    async fetchTradingFees(params = {}) {
        /**
         * @method
         * @name geniusyield#fetchTradingFees
         * @description fetch the trading fees for multiple markets
         * @see https://api-docs-v3.geniusyield.io/#get-api-account
         * @param {object} [params] extra parameters specific to the exchange API endpoint
    ...
    async fetchOrderBook(symbol, limit = undefined, params = {}) {
        /**
         * @method
         * @name geniusyield#fetchOrderBook
         * @description fetches information on open orders with bid (buy) and ask (sell) prices, volumes and other data
         * @see https://api-docs-v3.geniusyield.io/#get-order-books
    ...
    async fetchCurrencies(params = {}) {
        /**
         * @method
         * @name geniusyield#fetchCurrencies
         * @description fetches all available currencies on an exchange
         * @see https://api-docs-v3.geniusyield.io/#get-assets
         * @param {object} [params] extra parameters specific to the exchange API endpoint
    ...
    async fetchBalance(params = {}) {
        /**
         * @method
         * @name geniusyield#fetchBalance
         * @description query for balance and get the amount of funds available for trading or funds locked in orders
         * @see https://api-docs-v3.geniusyield.io/#get-balances
         * @param {object} [params] extra parameters specific to the exchange API endpoint
    ...
    async fetchMyTrades(symbol = undefined, since = undefined, limit = undefined, params = {}) {
        /**
         * @method
         * @name geniusyield#fetchMyTrades
         * @description fetch all trades made by the user
         * @see https://api-docs-v3.geniusyield.io/#get-fills
    ...
    async fetchOrder(id, symbol = undefined, params = {}) {
        /**
         * @method
         * @name geniusyield#fetchOrder
         * @description fetches information on an order made by the user
         * @see https://api-docs-v3.geniusyield.io/#get-orders
    ...
    async fetchOpenOrders(symbol = undefined, since = undefined, limit = undefined, params = {}) {
        /**
         * @method
         * @name geniusyield#fetchOpenOrders
    ...
    async fetchClosedOrders(symbol = undefined, since = undefined, limit = undefined, params = {}) {
        /**
         * @method
         * @name geniusyield#fetchClosedOrders
    ...
    parseOrderStatus(status) {
        // https://docs.geniusyield.io/#order-states-amp-lifecycle
        const statuses = {
            'active': 'open',
    ...
    async createOrder(symbol, type, side, amount, price = undefined, params = {}) {
        /**
         * @method
         * @name geniusyield#createOrder
         * @description create a trade order, https://docs.geniusyield.io/#create-order
         * @see https://api-docs-v3.geniusyield.io/#create-order
        ...
        // https://docs.geniusyield.io/#time-in-force
        ...
        // https://docs.geniusyield.io/#self-trade-prevention
    ...
    async withdraw(code, amount, address, tag = undefined, params = {}) {
        /**
         * @method
         * @name geniusyield#withdraw
         * @description make a withdrawal
         * @see https://api-docs-v3.geniusyield.io/#withdraw-funds
    ...
    async cancelAllOrders(symbol = undefined, params = {}) {
        /**
         * @method
         * @name geniusyield#cancelAllOrders
         * @description cancel all open orders
         * @see https://api-docs-v3.geniusyield.io/#cancel-order
    ...
    async fetchDeposit(id, code = undefined, params = {}) {
        /**
         * @method
         * @name geniusyield#fetchDeposit
         * @description fetch information on a deposit
         * @see https://api-docs-v3.geniusyield.io/#get-deposits
         * @param {string} id deposit id
         * @param {string} code not used by geniusyield fetchDeposit ()
         * @param {object} [params] extra parameters specific to the exchange API endpoint
         * @returns {object} a [transaction structure]{@link https://docs.ccxt.com/#/?id=transaction-structure}
         */
        await this.loadMarkets();
    ...
    async fetchDeposits(code = undefined, since = undefined, limit = undefined, params = {}) {
        /**
         * @method
         * @name geniusyield#fetchDeposits
    ...
    async fetchStatus(params = {}) {
        /**
         * @method
         * @name geniusyield#fetchStatus
         * @description the latest known information on the availability of the exchange API
         * @see https://api-docs-v3.geniusyield.io/#get-ping
         * @param {object} [params] extra parameters specific to the exchange API endpoint
    ...
    async fetchTime(params = {}) {
        /**
         * @method
         * @name geniusyield#fetchTime
         * @description fetches the current integer timestamp in milliseconds from the exchange server
         * @see https://api-docs-v3.geniusyield.io/#get-time
         * @param {object} [params] extra parameters specific to the exchange API endpoint
    ...
    async fetchWithdrawal(id, code = undefined, params = {}) {
        /**
         * @method
         * @name geniusyield#fetchWithdrawal
         * @description fetch data on a currency withdrawal via the withdrawal id
         * @see https://api-docs-v3.geniusyield.io/#get-withdrawals
         * @param {string} id withdrawal id
         * @param {string} code not used by geniusyield.fetchWithdrawal
         * @param {object} [params] extra parameters specific to the exchange API endpoint
         * @returns {object} a [transaction structure]{@link https://docs.ccxt.com/#/?id=transaction-structure}
         */
        await this.loadMarkets();
    ...
    async fetchWithdrawals(code = undefined, since = undefined, limit = undefined, params = {}) {
        /**
         * @method
         * @name geniusyield#fetchWithdrawals
    ...
    async fetchDepositAddress(code = undefined, params = {}) {
        /**
         * @method
         * @name geniusyield#fetchDepositAddress
         * @description fetch the Polygon address of the wallet
         * @see https://api-docs-v3.geniusyield.io/#get-wallets
         * @param {string} code not used by geniusyield
         * @param {object} [params] extra parameters specific to the exchange API endpoint
    ...
    sign(path, api = 'public', method = 'GET', params = {}, headers = undefined, body = undefined) {
        ...
        if (this.apiKey !== undefined) {
            headers['Genius Yield-API-Key'] = this.apiKey;
        }
        if (api === 'private') {
            ...
            headers['Genius Yield-HMAC-Signature'] = this.hmac(this.encode(payload), this.encode(this.secret), sha256.sha256, 'hex');
        }
