...
public partial class geniusyield : Exchange
{
    public override object describe()
    {
        return this.deepExtend(base.describe(), new Dictionary<string, object>() {
            ...
            { "urls", new Dictionary<string, object>() {
                ...
                { "doc", new List<object>() {"https://api-docs-v3.geniusyield.io/"} },
            } },
            { "api", new Dictionary<string, object>() {
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        {
            ((IDictionary<string,object>)headers)["Genius Yield-API-Key"] = this.apiKey;
        }
        if (isTrue(isEqual(api, "private")))
        {
            ...
            ((IDictionary<string,object>)headers)["Genius Yield-HMAC-Signature"] = this.hmac(this.encode(payload), this.encode(this.secret), sha256, "hex");
        }
        return new Dictionary<string, object>() {
            { "url", url },
            { "method", method },
