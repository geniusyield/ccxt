...
class geniusyield(Exchange, ImplicitAPI):
    ...
    def fetch_deposit(self, id: str, code: Str = None, params={}):
        ...
        :param str code: not used by geniusyield fetchDeposit()
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a `transaction structure <https://docs.ccxt.com/#/?id=transaction-structure>`
        """
        self.load_markets()
    ...
    def fetch_withdrawal(self, id: str, code: Str = None, params={}):
        ...
        :param str code: not used by geniusyield.fetchWithdrawal
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: a `transaction structure <https://docs.ccxt.com/#/?id=transaction-structure>`
        """
        self.load_markets()
    ...
    def fetch_deposit_address(self, code: Str = None, params={}):
        ...
        :param str code: not used by geniusyield
        :param dict [params]: extra parameters specific to the exchange API endpoint
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if self.apiKey is not None:
            headers['Genius Yield-API-Key'] = self.apiKey
        if api == 'private':
            payload = None
            if method == 'GET':
                payload = query
                ...
                payload = body
            headers['Genius Yield-HMAC-Signature'] = self.hmac(self.encode(payload), self.encode(self.secret), hashlib.sha256, 'hex')
